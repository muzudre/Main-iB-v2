@extends('backpack::layout') @section('header')
    <section class="content-header">
        ...
        <br>
        <a href="{{ url('admin/users') }}"><i class="glyphicon glyphicon-arrow-left"></i> Back to all agents</a>
    </section>
        ...
        <div class="col-md-6">
            <div class="box box-default">
                <div class="box-header with-border">
                    ...
                    <!-- /.info-box -->
                    <a href="{{ url('') }}" class="btn btn-primary ladda-button">
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="" class="btn btn-xs btn-default bg-orange"><i class="fa fa-edit"></i> update</a>

                                            <a href="{{ url('/admin/policy/'.$polic->id) }}" class="btn btn-xs btn-default bg-red" data-button-type="delete"><i class="fa fa-trash"></i> {{ trans('backpack::crud.delete') }}</a>
